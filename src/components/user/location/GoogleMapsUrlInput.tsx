...
const formSchema = z.object({
  googleMapsUrl: z.string().min(1, {
    message: "La url de Google Maps es requerida",
  }),
});

export const GoogleMapsUrlInput = ({
  id,
  initialData,
  ...
  const googleMapsUrl = currentData?.googleMapsUrl || "";
        ...
        <div className="pt-6 sm:flex">
          ...
          <dd className="mt-1 flex justify-between items-center gap-x-6 sm:mt-0 sm:flex-auto">
            {isEditing ? (
              ...
              <div className="text-gray-900">{googleMapsUrl}</div>
            )}
