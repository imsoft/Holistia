      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <p className="text-base text-muted-foreground">
              Elige qué parte de la imagen del evento quieres que se muestre en la card
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-muted rounded-lg">
              <h4 className="font-medium text-base mb-3">💡 Consejos para eventos:</h4>
              <ul className="text-sm text-muted-foreground space-y-2">
                <li>• <strong>Centro</strong>: Para imágenes equilibradas</li>
                <li>• <strong>Superior</strong>: Para mostrar logos o títulos</li>
                <li>• <strong>Inferior</strong>: Para mostrar espacios o ambientes</li>
