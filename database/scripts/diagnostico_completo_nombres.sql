-- ============================================================================
-- Script de diagnóstico completo para nombres de pacientes
-- ============================================================================
-- Fecha: 25 de octubre de 2025
-- Propósito: Diagnosticar por qué los nombres siguen apareciendo como "Paciente d89373fe"
-- ============================================================================
...
-- ============================================================================
-- PASO 6: Verificar si hay problemas con RLS
-- ============================================================================

-- Verificar políticas RLS en las tablas subyacentes
SELECT 
  '🔒 POLÍTICAS RLS EN TABLAS SUBYACENTES' as seccion,
  tablename,
  policyname,
  cmd,
  roles
...
WHERE schemaname = 'public' 
  AND tablename IN ('profiles', 'appointments', 'professional_applications')
ORDER BY tablename, policyname;

-- ============================================================================
-- PASO 7: Verificar si la vista tiene security_barrier
-- ============================================================================

SELECT 
  '🛡️ CONFIGURACIÓN DE SEGURIDAD DE LA VISTA' as seccion,
  schemaname,
  viewname,
  viewowner,
  CASE 
    WHEN definition LIKE '%security_barrier%' THEN '✅ Tiene security_barrier'
    ELSE '❌ No tiene security_barrier'
  END as seguridad
FROM pg_views 
WHERE schemaname = 'public' 
  AND viewname = 'professional_patient_info';
...
SELECT 
  ...
  '5. Verificar que el profesional está autenticado correctamente' as paso_5;
