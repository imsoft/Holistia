...
const navigation = {
  ...
  social: [
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@holistia_io?_t=ZS-90Fd0MzUS81&_r=1",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <div className="mx-auto max-w-4xl text-center">
          <hgroup>
            ...
            <p className="mt-2 text-4xl font-semibold tracking-tight text-balance text-foreground sm:text-5xl">
              Atrévete a descubrir nuevas posibilidades para tu crecimiento
              personal
            </p>
          </hgroup>
          <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-muted-foreground">
            Reserva tu experiencia y cuéntanos cómo te fue a{" "}
            <Link
              href="mailto:hola@holistia.io?subject=Consulta sobre mi experiencia en Holistia&body=Hola,%0D%0A%0D%0AMe gustaría compartir mi experiencia con Holistia y hacer algunas consultas.%0D%0A%0D%0A¡Gracias!"
