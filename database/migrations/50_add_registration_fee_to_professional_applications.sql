...
-- Fecha: 2025-10-22
-- Descripción: Los profesionales deben pagar una cuota de inscripción de $1,000 MXN
...
ADD COLUMN registration_fee_amount NUMERIC DEFAULT 1000.00,
...
COMMENT ON COLUMN professional_applications.registration_fee_paid IS 'Indica si el profesional ha pagado la cuota de inscripción de $1,000 MXN';
COMMENT ON COLUMN professional_applications.registration_fee_amount IS 'Monto de la cuota de inscripción (por defecto $1,000 MXN)';
