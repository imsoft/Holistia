...
const SignupPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Por ahora, redirigimos directamente a my-space
    ...
    <>
      <div className="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-card px-6 py-12 shadow-sm sm:rounded-lg sm:px-12 border border-border">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    autoComplete="name"
                    className="block w-full rounded-md bg-background px-3 py-1.5 text-base text-foreground outline-1 -outline-offset-1 outline-border placeholder:text-muted-foreground focus:outline-2 focus:-outline-offset-2 focus:outline-ring sm:text-sm/6"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-3">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="block text-sm/6 text-foreground"
                  >
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-1 gap-4">
                <Link
                  href="#"
                  className="flex w-full items-center justify-center gap-3 rounded-md bg-background px-3 py-2 text-sm font-semibold text-foreground shadow-xs border border-border hover:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
                >
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
          ...
          {/* Botones de Demo */}
          <div className="mt-8 p-4 bg-muted/30 rounded-lg border border-dashed border-muted-foreground/30">
            <p className="text-sm font-medium text-center text-muted-foreground mb-4">
              Botones de Demo - Solo para Pruebas
            </p>
            ...
            <p className="text-xs text-center text-muted-foreground mt-3">
              Estos botones se eliminarán en producción
            </p>
          </div>
