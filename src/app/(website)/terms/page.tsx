  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16 max-w-4xl">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Términos y Condiciones</h1>
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">1. Aceptación de los Términos</h2>
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">2. Descripción del Servicio</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">3. Registro y Cuenta de Usuario</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">4. Responsabilidades del Usuario</h2>
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">5. Profesionales de la Salud</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">6. Política de Pagos y Reembolsos</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">7. Limitación de Responsabilidad</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">8. Propiedad Intelectual</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">9. Modificaciones</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
          ...
          <section className="mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">10. Contacto</h2>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
